...
export interface MoltbotEnv {
  ...
  OPENCLAW_DEFAULT_MODEL?: string; // Override default model ID (e.g. "claude-sonnet-4-6") for direct provider keys
  OPENCLAW_THINKING?: string; // Thinking level: "off", "low", "medium", "high"
